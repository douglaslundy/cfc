	...
	<form:form action="${s:mvcUrl('VC#grava').build()}" method="post"
		...
		<div class="form-group">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<form:input path="marca" class="form-control col-md-7 col-xs-12" />
		...
		<div class="form-group">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<form:input path="ano" class="form-control col-md-7 col-xs-12" />
		...
		<div class="form-group">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<form:input path="modelo" class="form-control col-md-7 col-xs-12" />
		...
		<div class="form-group">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<form:input path="cor" class="form-control col-md-7 col-xs-12" />
		...
		<div class="form-group">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<form:input path="chassi" class="form-control col-md-7 col-xs-12" />
		...
		<div class="form-group">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<form:input path="renavan" class="form-control col-md-7 col-xs-12" />
		...
		<div class="form-group">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<form:input path="placa" class="form-control col-md-7 col-xs-12" />
		...
		<div class="form-group">
			...
			<div class="col-md-6 col-sm-6 col-xs-12">
				<form:input path="kmInicial" class="form-control col-md-7 col-xs-12" />
